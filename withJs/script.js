...
//we need article, button and input
...
form.addEventListener('submit',function(e){
    ...
    // so we should use preventDefault method
    e.preventDefault();  
    // If we don't use parseInt function, then value will be a string.
    // If we use, then value will be a number
